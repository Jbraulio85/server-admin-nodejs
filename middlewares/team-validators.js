...
export const validateCreateTeam = [
  ...
  body('namedMembers')
    .optional()
    .isString()
    .withMessage('namedMembers debe enviarse como JSON en texto'),
  checkValidators,
];
...
export const validateTeamNamedMemberAdmin = [
  validateJWT,
  requireRole('ADMIN_ROLE'),
  param('id')
    .isMongoId()
...
export const validateRemoveNamedMemberAdmin = [
  validateJWT,
  requireRole('ADMIN_ROLE'),
  param('id')
    .isMongoId()
  ...
  param('memberId')
    .isMongoId()
    .withMessage('ID de miembro debe ser un ObjectId válido de MongoDB'),
  checkValidators,
];
